...
import 'package:flutter_app_teacher_titya/wheater.dart';
...
Future<void> fetchData() async {
  ...
  if (respone.statusCode == 200) {
    wheatherModel m = wheatherModel.fromJson(jsonDecode(respone.body));
  } else {}
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      title: "ទាយហុងស៊ុយលេខទូរស័ព្ទ",
    );
  }
}

class GuessPhoneNumberScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder(
